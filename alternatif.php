  ...
  <body>
	<div class="container">
      ...
      <nav class="navbar navbar-default">
		...
		<ol class="breadcrumb">
		  <li><a href="index.php">Home</a></li>
		  <li class="active">Alternatif Lokasi</li>
		</ol>
      <!-- Main component for a primary marketing message or call to action -->
      <div class="panel panel-primary">
		  <!-- Default panel contents -->
		  <div class="panel-heading">Alternatif Lokasi</div>
						<?php
							include 'configdb.php';
		  ...
		  <div class="panel-body table-responsive">
			<a class='btn btn-primary' href='add-alternatif.php'> Tambah Alternatif Lokasi</a><br /><br />
										...
										<?php
												...
												while ($row = $alternatif->fetch_assoc()) {
													...
													?>
														  ...
														  <a href="del2.php?id=<?php echo $row['id_alternatif'];?>" onClick="return confirm('Hapus Data Alternatif Lokasi ke-<?php echo $i-1;?> ?');" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Delete</a></td>
													<?php
													echo '</tr>';
												}
										?>
