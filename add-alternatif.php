	...
	<div class="container">
      ...
      <nav class="navbar navbar-default">
		...
		<ol class="breadcrumb">
		  ...
		  <li class="active">Tambah Alternatif Lokasi</li>
		</ol>
      <!-- Main component for a primary marketing message or call to action -->
      <div class="panel panel-primary">
		  <!-- Default panel contents -->
		  <div class="panel-heading">Tambah Alternatif Lokasi</div>
		  <div class="panel-body">
										...
										?>
							<form role="form" method="post" action="add2.php">
                                    <div class="box-body">
										<div class="form-group">
                                            <label for="lokasi">Lokasi</label>
                                            <input type="text" class="form-control" name="lokasi" id="lokasi" placeholder="Lokasi yang akan dianalisa" required>
                                        </div>
                                        <div class="form-group">
