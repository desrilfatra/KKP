	...
	<div class="container">
      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-body">
			<center>
			<h4>Hasil Analisa Lokasi Alternatif Rumah Tinggal</h4>
			<div style="width: 50%">
				<canvas id="canvas" height="450" width="600"></canvas>
						...
						<?php
							...
							uasort($r,'cmp');
							echo "<div class='alert alert-info'>".ucwords($alt_name[array_search((end($r)), $r)])." adalah lokasi paling strategis untuk Rumah tinggal.</div>";
