		  ...
		  <div class="panel-body">
			<center>
				<?php
					...
					echo "<h5>Nilai Atribut ".ucwords($kri[1])."</h5>"; //tabel atribut Jarak Dengan Fasilitas Umum
					echo "<table class='table table-striped table-bordered table-hover'>";
					...
					echo "</br>";
					if(($ya+$no)==1){
						if($ya>$no) echo "<div class='alert alert-info'>Berdasarkan perhitungan, maka Lokasi ".ucwords($lokasi)." tersebut strategis untuk pendirian Rumah Tinggal.</div>";
						else echo "<div class='alert alert-danger'>Berdasarkan perhitungan, maka Lokasi ".ucwords($lokasi)." tersebut kurang strategis untuk pendirian Rumah Tinggal.</div>";
					}
					...
					function print_ar(array $x){	// print array
						echo "<pre>";
						print_r($x);
						echo "</pre></br>";
					}
