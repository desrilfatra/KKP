  ...
  <body>
	<div class="container">
      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-heading">Data Aturan</div>
						<?php
							include 'configdb.php';
		  ...
		  <div class="panel-body table-responsive">
			<a class='btn btn-primary' href='add-aturan.php'> Tambah Data Aturan</a><br /><br />
			...
			<tbody>
										<?php
												...
												while ($row = $aturan->fetch_assoc()) {
													...
													?>
														  <a href="edit-aturan.php?id=<?php echo $row['id_aturan'];?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a>
														  <a href="del.php?id=<?php echo $row['id_aturan'];?>" onClick="return confirm('Hapus Data Aturan ke-<?php echo $i-1;?> ?');" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Delete</a></td>
													<?php
													echo '</tr>';
												}
										?>
