	...
	<div class="container">
      ...
      <nav class="navbar navbar-default">
		...
		<ol class="breadcrumb">
		  ...
		  <li class="active">Edit Data Aturan</li>
		</ol>
      <!-- Main component for a primary marketing message or call to action -->
      <div class="panel panel-primary">
		  <!-- Default panel contents -->
		  <div class="panel-heading">Edit Data Aturan</div>
						<?php
									...
									$result = $mysqli->query("select * from aturan where id_aturan = ".$_GET['id']."");
									if(!$result){
										echo $mysqli->connect_errno." - ".$mysqli->connect_error;
										exit();
									}
                                    ...
                                    <div class="box-body">
										...
										<div class="form-group">
                                            ...
                                            <select class="form-control" name="k5" id="k5">
												<option value='ya' <?php if($row["k5"]=='ya') echo "selected"?>>Ya</option>
												<option value='tidak' <?php if($row["k5"]=='tidak') echo "selected"?>>Tidak</option>
										    </select>
                                        </div>
                                    </div><!-- /.box-body -->
